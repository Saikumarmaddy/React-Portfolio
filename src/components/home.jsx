...
function Home() {
  ...
  return (
    <section className="w-full px-20 max-[540px]:px-8">
      <div className="h-47vh p-4 flex justify-end max-[420px]:flex-col max-[800px]:justify-center">
        <div className="h-47vh p-4 my-20 flex flex-col justify-center max-[1040px]:text-xl max-[800px]:hidden">
          <div className="font-serif p-2">
            <div className="py-4 text-5xl text-white max-[945px]:text-2xl">
              {opening_line}
            </div>
            <div className="py-4 text-8xl text-[#cfd9e1] font-bold max-[945px]:text-3xl">
              {resource_name}
            </div>
            <div className="py-4 text-6xl text-[#fc8079] font-semibold max-[945px]:text-2xl">
              {role}
            </div>
          </div>
      ...
      <div className="h-37vh p-4 flex flex-col justify-center items-center">
        <div className="grow flex items-center py-1 text-3xl font-normal text-center tracking-wide text-[#cfd9e1] italic max-[945px]:text-2xl max-[1200px]:text-left max-[540px]:text-xl max-[450px]:text-lg">
          {quotation_three}
        </div>
        <div className="grow w-11/12 text-4xl font-medium text-right tracking-wide text-[#fc8079] italic max-[945px]:text-2xl max-[540px]:text-xl max-[450px]:text-base">
          {quotation_three_sub}
        </div>
      </div>
    </section>
